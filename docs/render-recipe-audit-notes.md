...
| North Bridge, night | `2:8:$00` | `02/03` | `$21` | `fixed:$CB15` |
...
| Castlevania final area, fixed | `5:0:$00` | `0B/0C` | `$57` | `4:$A150` |
...
The Castlevania final-area probe closes the last diagnostic recipe family. It
uses CHR banks `0B/0C` and palette transfer `$57 -> 4:$A150`. This is a
fixed-palette final area, not a day/night exterior.

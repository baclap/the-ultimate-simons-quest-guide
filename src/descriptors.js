...
function normalizeBackgroundDescriptor(raw) {
  ...
  const descriptor = {
    ...
    paletteBank: parseInteger(raw.paletteBank, 'paletteBank'),
    paletteAddress: parseInteger(raw.paletteAddress, 'paletteAddress'),
    paletteLength: parseInteger(raw.paletteLength, 'paletteLength'),

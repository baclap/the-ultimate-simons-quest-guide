...
const BUILD_VERSION = typeof __GUIDE_BUILD_VERSION__ !== 'undefined' ? __GUIDE_BUILD_VERSION__ : 'dev';
const REPOSITORY_URL = typeof __GUIDE_REPOSITORY_URL__ !== 'undefined'
  ? __GUIDE_REPOSITORY_URL__
  : 'https://github.com/baclap/the-ultimate-simons-quest-guide';
...
const SLICE_URL = publicAssetUrl('assets/slices/jova-to-berkeley/slice.json');
const FONT_URL = publicAssetUrl('assets/fonts/cv2-dialog.json');
const MUSIC_DATA_URL = publicAssetUrl('assets/audio/cv2-music-data.js');
const MUSIC_WORKLET_URL = publicAssetUrl('assets/audio/cv2-apu-worklet.js');
...
const SECRET_FEATURE_SOUND_EFFECT_TRACK_IDS = new Map([
  ['deborah-cliff-red-crystal-kneel-tornado', MUSIC_TRACK_IDS.deborahTornadoEvent]
]);
...
const MAP_VIEWS = {
  ...
  [BERKELEY_MANSION_VIEW_ID]: {
    ...
    fixedVariant: 'fixed',
    sceneUrl: publicAssetUrl('assets/scenes/berkeley-mansion/slice.json'),
    renderer: null
  },
  [BRAHM_MANSION_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'fixed',
    sceneUrl: publicAssetUrl('assets/scenes/brahm-mansion/slice.json'),
    renderer: null
  },
  [JOVA_CHURCH_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/jova-church/slice.json'),
    renderer: null
  },
  [JOVA_THORN_WHIP_ROOM_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/jova-thorn-whip-room/slice.json'),
    renderer: null
  },
  [JOVA_HOLY_WATER_ROOM_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/jova-holy-water-room/slice.json'),
    renderer: null
  },
  [VEROS_DAGGER_ROOM_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/veros-dagger-room/slice.json'),
    renderer: null
  },
  [VEROS_CHURCH_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/veros-church/slice.json'),
    renderer: null
  },
  [VEROS_CHAIN_WHIP_ROOM_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/veros-chain-whip-room/slice.json'),
    renderer: null
  },
  [ALJIBA_GARLIC_ROOM_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/aljiba-garlic-room/slice.json'),
    renderer: null
  },
  [ALJIBA_BOOK_OLD_LADY_ROOM_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/aljiba-book-old-lady-room/slice.json'),
    renderer: null
  },
  [ALJIBA_LAURELS_ROOM_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/aljiba-laurels-room/slice.json'),
    renderer: null
  },
  [ALBA_GARLIC_ROOM_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/alba-garlic-room/slice.json'),
    renderer: null
  },
  [ALBA_CHURCH_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/alba-church/slice.json'),
    renderer: null
  },
  [ALBA_LAURELS_ROOM_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/alba-laurels-room/slice.json'),
    renderer: null
  },
  [ONDOL_MORNING_STAR_ROOM_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/ondol-morning-star-room/slice.json'),
    renderer: null
  },
  [ONDOL_DEATH_STAR_LADY_ROOM_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/ondol-death-star-lady-room/slice.json'),
    renderer: null
  },
  [ONDOL_LAURELS_ROOM_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/ondol-laurels-room/slice.json'),
    renderer: null
  },
  [LAUBER_MANSION_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'fixed',
    sceneUrl: publicAssetUrl('assets/scenes/lauber-mansion/slice.json'),
    renderer: null
  },
  [DOINA_GET_BACK_LADY_ROOM_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/doina-get-back-lady-room/slice.json'),
    renderer: null
  },
  [DOINA_LAURELS_ROOM_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/doina-laurels-room/slice.json'),
    renderer: null
  },
  [YOMI_EMPTY_ROOM_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/yomi-empty-room/slice.json'),
    renderer: null
  },
  [YOMI_GIRLFRIEND_ROOM_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'day',
    sceneUrl: publicAssetUrl('assets/scenes/yomi-girlfriend-room/slice.json'),
    renderer: null
  },
  [LARUBA_MANSION_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'fixed',
    sceneUrl: publicAssetUrl('assets/scenes/laruba-mansion/slice.json'),
    renderer: null
  },
  [BODLEY_MANSION_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'fixed',
    sceneUrl: publicAssetUrl('assets/scenes/bodley-mansion/slice.json'),
    renderer: null
  },
  [CASTLEVANIA_VIEW_ID]: {
    ...
    supportsPalette: false,
    fixedVariant: 'fixed',
    sceneUrl: publicAssetUrl('assets/scenes/castlevania/slice.json'),
    renderer: null
  }
};
...
const dom = {
  ...
  guideVersion: document.querySelector('#guide-version'),
...
initializeGuideMetadata();

function setStatus(message) {
  dom.status.textContent = message;
}

function initializeGuideMetadata() {
  dom.guideVersion.textContent = `v${BUILD_VERSION}`;
  dom.repoLink.href = REPOSITORY_URL;
}
...
function setLoadingState({
  ...
  const disablesTransition = !active || (active && !wasActive);
  if (disablesTransition) {
...
function hideLoadingState() {
  setLoadingState({ active: false, progress: 0, label: 'READY' });
}
...
async function registerGuideServiceWorker() {
  if (!serviceWorkerSupported()) {
    return null;
  }
  if (import.meta.env.DEV) {
    await clearGuideServiceWorkers();
    return null;
  }
  try {
    const version = encodeURIComponent(BUILD_VERSION);
    return await navigator.serviceWorker.register(publicAssetUrl(`sw.js?version=${version}`), {
      scope: PUBLIC_BASE_URL
    });
  } catch (error) {
    console.warn('Unable to register guide service worker.', error);
    return null;
  }
}

async function clearGuideServiceWorkers() {
  try {
    ...
    if ('caches' in window) {
      ...
      await Promise.all(cacheNames
        .filter((cacheName) => cacheName.startsWith('ultimate-simons-quest-guide'))
        .map((cacheName) => caches.delete(cacheName)));
    }
  } catch (error) {
    console.warn('Unable to clear guide service worker caches for dev mode.', error);
  }
}

async function warmGuideOfflineCache(registrationPromise) {
  if (!serviceWorkerSupported()) {
    return;
  }
  if (import.meta.env.DEV) {
  ...
  try {
    ...
    const response = await fetch(publicAssetUrl('asset-manifest.json'));
    if (!response.ok) {
      return;
    }
    ...
    worker?.postMessage({
      type: 'CACHE_GUIDE_ASSETS',
      version: BUILD_VERSION,
      assets
    });
  } catch (error) {
    console.warn('Unable to warm guide offline cache.', error);
  }
}
...
let guideMusicSfxNode = null;
let guideMusicMediaDestination = null;
let guideMusicOutputElement = null;
let guideMusicReadyPromise = null;
let guideMusicSfxStopTimer = null;
...
let guideMusicSfxPlayToken = 0;
let guideMusicReplacingSfxToken = null;
...
async function ensureGuideMusicTracks() {
  ...
  if (!guideMusicDataPromise) {
    guideMusicDataPromise = loadGuideMusicData().then((data) => {
      guideMusicDmcSamples = data.dmcSamples || [];
...
async function loadGuideMusicData() {
  const response = await fetch(MUSIC_DATA_URL);
  if (!response.ok) {
    throw new Error(`Unable to load guide music data: ${response.status} ${response.statusText}`);
  }
  const source = await response.text();
  const prefix = 'export const GUIDE_MUSIC_DATA =';
  const start = source.indexOf(prefix);
  if (start === -1) {
    throw new Error('Guide music data file is missing GUIDE_MUSIC_DATA export.');
  }
...
function expandGuideMusicSoundEffectTrack(track, initialWrites = []) {
  const frames = expandGuideMusicTrack(track).map((frame) => frame.slice());
  if (initialWrites.length > 0) {
    if (frames.length === 0) {
      frames.push([]);
    }
    frames[0].unshift(...initialWrites);
  }
  return frames;
}
...
function ensureGuideMusicOutputElement() {
  if (guideMusicOutputElement) {
    return guideMusicOutputElement;
  }
  ...
  guideMusicOutputElement = audio;
  return guideMusicOutputElement;
}

function connectGuideMusicOutput(node) {
  const audio = ensureGuideMusicOutputElement();
  if (guideMusicAudioContext.createMediaStreamDestination && 'srcObject' in audio) {
    if (!guideMusicMediaDestination) {
      guideMusicMediaDestination = guideMusicAudioContext.createMediaStreamDestination();
      audio.srcObject = guideMusicMediaDestination.stream;
    }
    node.connect(guideMusicMediaDestination);
    return;
  }
  node.connect(guideMusicAudioContext.destination);
}

async function startGuideMusicOutput() {
  if (guideMusicAudioContext?.state === 'suspended') {
    await guideMusicAudioContext.resume();
  }
  if (guideMusicOutputElement?.srcObject && guideMusicOutputElement.paused) {
    await guideMusicOutputElement.play();
  }
}

async function ensureGuideMusicAudio() {
  if (guideMusicAudioContext && guideMusicNode) {
    await startGuideMusicOutput();
  ...
  guideMusicReadyPromise = (async () => {
    ...
    connectGuideMusicOutput(guideMusicNode);
    await startGuideMusicOutput();
  })();
...
async function playGuideMusicTrack(trackId) {
  ...
  if (guideMusicMuted || guideMusicReplacingSfxToken !== null) {
    return;
  }
  ...
  const canLoop = track.canLoop !== false;
  const endFrame = canLoop
    ? (track.loop?.endFrame || track.frameCount)
    : (track.playbackEndFrame || track.loop?.startFrame || track.frameCount);
  ...
  node.port.postMessage({
    ...
    canLoop,
    dmcSamples: guideMusicDmcSamples
  });
  node.port.postMessage({ type: 'play' });
  guideMusicCurrentTrackId = trackId;
}

function disconnectGuideMusicSfxNode(node) {
  if (!node) {
    return;
  }
  if (guideMusicSfxStopTimer) {
    clearTimeout(guideMusicSfxStopTimer);
    guideMusicSfxStopTimer = null;
  }
  try {
    node.port.postMessage({ type: 'stop' });
  } catch {
    // The node may already be torn down after a browser audio shutdown.
  }
  try {
    node.disconnect();
  } catch {
    // Disconnect is best-effort; stale one-shot nodes are harmless once stopped.
  }
}

function handleGuideMusicPlaybackError(error) {
...
function pauseGuideMusicForReplacingSoundEffect(token) {
  guideMusicReplacingSfxToken = token;
  guideMusicPlayToken += 1;
  guideMusicCurrentTrackId = null;
  try {
    guideMusicNode?.port.postMessage({ type: 'stop' });
  } catch {
    // Browser audio shutdowns can invalidate the node while an effect is ending.
  }
}

function finishReplacingGuideMusicSoundEffect(token, { resumeMusic = true } = {}) {
  if (guideMusicReplacingSfxToken !== token) {
    return;
  }
  guideMusicReplacingSfxToken = null;
  if (!resumeMusic || guideMusicMuted) {
    return;
  }
  playGuideMusicTrack(guideMusicDesiredTrackId).catch(handleGuideMusicPlaybackError);
}

function finishGuideMusicSoundEffect(node, token, { resumeMusic = true } = {}) {
  if (token !== guideMusicSfxPlayToken) {
    return;
  }
  if (guideMusicSfxNode === node) {
    guideMusicSfxNode = null;
  }
  disconnectGuideMusicSfxNode(node);
  finishReplacingGuideMusicSoundEffect(token, { resumeMusic });
}

async function playGuideMusicSoundEffect(trackId, options = {}) {
  if (!trackId || guideMusicMuted) {
    return;
  }
  const tracksById = await ensureGuideMusicTracks();
  const track = tracksById.get(trackId);
  ...
  const replacesMusic = options.replaceMusic === true;
  if (guideMusicSfxNode) {
    finishGuideMusicSoundEffect(guideMusicSfxNode, guideMusicSfxPlayToken, {
      resumeMusic: !replacesMusic
    });
  }

  const token = ++guideMusicSfxPlayToken;
  await ensureGuideMusicAudio();
  if (token !== guideMusicSfxPlayToken || guideMusicMuted || !guideMusicAudioContext) {
    return;
  }

  if (replacesMusic) {
    pauseGuideMusicForReplacingSoundEffect(token);
  }

  const node = new AudioWorkletNode(guideMusicAudioContext, 'cv2-apu', {
    numberOfInputs: 0,
    numberOfOutputs: 1,
    outputChannelCount: [2]
  });
  guideMusicSfxNode = node;
  connectGuideMusicOutput(node);
  node.port.onmessage = (event) => {
    const message = event.data || {};
    if (message.type !== 'status' || !message.finished || token !== guideMusicSfxPlayToken) {
      return;
    }
    finishGuideMusicSoundEffect(node, token);
  };

  const endFrame = track.playbackEndFrame || track.loop?.startFrame || track.frameCount;
  const initialWrites = Array.isArray(track.initialWrites) ? track.initialWrites : [0x15, 0x08];
  node.port.postMessage({ type: 'reset' });
  node.port.postMessage({
    type: 'track',
    frames: expandGuideMusicSoundEffectTrack(track, initialWrites),
    startFrame: track.playbackStartFrame || 0,
    endFrame,
    loopStartFrame: 0,
  ...
  node.port.postMessage({ type: 'play' });
  if (Number.isFinite(options.stopAtMs)) {
    const delayMs = Math.max(0, options.stopAtMs - performance.now());
    guideMusicSfxStopTimer = setTimeout(() => {
      finishGuideMusicSoundEffect(node, token);
    }, delayMs);
  }
  await startGuideMusicOutput();
...
function stopGuideMusic() {
  guideMusicPlayToken += 1;
  guideMusicSfxPlayToken += 1;
  guideMusicReplacingSfxToken = null;
  guideMusicCurrentTrackId = null;
  guideMusicNode?.port.postMessage({ type: 'stop' });
  disconnectGuideMusicSfxNode(guideMusicSfxNode);
  guideMusicSfxNode = null;
  guideMusicOutputElement?.pause();
}
...
function noteGuideMusicInteraction({ segmentId = null, actor = null } = {}) {
  // Interior segment ids are scene-local; preserve the overworld segment that led into the room.
  if (segmentId && state.activeViewId === OVERWORLD_VIEW_ID) {
    guideMusicLastSegmentId = segmentId;
  }
  if (actor) {
...
function triggerSecretFeatureAnimation(featureId) {
  ...
  activeSecretAnimations.set(featureId, { startedAt });
  return {
    feature,
    startedAt,
    durationMs: Number.isFinite(feature.animation.durationMs) && feature.animation.durationMs > 0
      ? feature.animation.durationMs
      : null
  };
}

function playSecretFeatureSoundEffect(feature, animationTrigger = null) {
  const trackId = feature?.soundEffectTrackId || SECRET_FEATURE_SOUND_EFFECT_TRACK_IDS.get(feature?.id);
  if (!trackId) {
    return;
  }
  const options = {
    ...(Number.isFinite(animationTrigger?.durationMs)
      ? { stopAtMs: animationTrigger.startedAt + animationTrigger.durationMs }
      : {}),
    replaceMusic: feature?.soundEffectReplacesMusic === true
  };
  playGuideMusicSoundEffect(trackId, options).catch((error) => {
    setStatus(error instanceof Error ? error.message : String(error));
  });
}
...
function showSecretFeatureCard(feature) {
  noteGuideMusicInteraction({ segmentId: feature.segmentId });
  const animationTrigger = triggerSecretFeatureAnimation(feature.triggerAnimationFeatureId);
  playSecretFeatureSoundEffect(feature, animationTrigger);
...
async function main() {
  const serviceWorkerRegistration = registerGuideServiceWorker();
  ...
  requestAnimationFrame(() => {
    hideLoadingState();
    void warmGuideOfflineCache(serviceWorkerRegistration);
  });
}
